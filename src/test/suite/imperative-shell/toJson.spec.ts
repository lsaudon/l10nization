...
import { toJson } from "../../../features/application/arb/arbSerializer";
...
describe("toJson", () => {
	it("should return json when simple messages", () => {
		expect(
			toJson(defaultArbJson, new L10nObject(true, "helloWorld", null, "Hello World", []), false),
		).to.be.equal(`{
  "@@locale": "fr",
  ...
  "helloWorld": "Hello'World"
	...
	it("should return json when message with description for template file", () => {
		expect(
			toJson(
				defaultArbJson,
				new L10nObject(true, "helloWorld", "Hello World Description", "Hello World", []),
				false,
			),
		).to.be.equal(`{
  "@@locale": "fr",
  ...
  "@hello": {
	...
	it("should return json when message with 1 placeholder and description", () => {
		expect(
			toJson(
				defaultArbJson,
				new L10nObject(true, "hello", "Hello by name", "Hello $name", [
					new Placeholder("name", "name", PlaceholderType.String),
				]),
				false,
			),
	...
	it("should return json when message with 1 placeholder int with format", () => {
		expect(
			toJson(
				defaultArbJson,
				new L10nObject(true, "hello", null, "Hello $name", [
					new Placeholder("name", "name", PlaceholderType.Int).addFormat("compact"),
				]),
				false,
			),
		).to.be.equal(`{
	...
	it("should return json when message with 1 placeholder DateTime", () => {
		expect(
			toJson(
				defaultArbJson,
				new L10nObject(true, "hello", null, "Hello $name", [
					new Placeholder("name", "name", PlaceholderType.DateTime).addFormat("yMd"),
				]),
				false,
			),
		).to.be.equal(`{
	...
	it("should return json when message with 1 placeholder DateTime not in valid list", () => {
		expect(
			toJson(
				defaultArbJson,
				new L10nObject(true, "hello", null, "Hello $name", [
					new Placeholder("name", "name", PlaceholderType.DateTime).addFormat("dd/MM/yyyy"),
				]),
				false,
			),
		).to.be.equal(`{
  ...
  "z": "Z {name}"
				...
				new L10nObject(true, "a", null, "A $name", [
					new Placeholder("name", "name", PlaceholderType.String),
				]),
				true,
			),
  ...
  "@z": {
	...
	it("should return json when message with 1 placeholder plural", () => {
		expect(
			toJson(
				defaultArbJson,
				new L10nObject(true, "countMessage", null, "You have $count photos", [
  ...
  "@countMessage": {
	...
	it("should return json when message with 1 placeholder plural 2", () => {
		expect(
			toJson(
				defaultArbJson,
				new L10nObject(true, "countMessage", null, "You have $otherCount photos", [
  ...
  "@countMessage": {
	...
	it("should return json when message with description non template file", () => {
		expect(
			toJson(
				defaultArbJson,
				new L10nObject(false, "helloWorld", "Hello World Description", "Hello World", []),
				false,
			),
		).to.be.equal(`{
  "@@locale": "fr",
  "helloWorld": "Hello World"
	...
	it("should return json when message with 1 placeholder for non template file", () => {
		expect(
			toJson(
				defaultArbJson,
				new L10nObject(false, "hello", null, "Hello $name", [
					new Placeholder("name", "name", PlaceholderType.String),
				]),
				false,
			),
